...
class ProfileController extends Controller
{
    ...
    public function index() 
    {
        ...
        return view('salesman.profile.edit_profile',compact('user_detail'));
    }
    ...
    {       
        ...
        return view('salesman.profile.edit_profile',compact('user_detail', 'role', 'roleId'));
    }
    ...
    {        
        ...
        $user_detail->save();
        return redirect()->route('salesman.dashboard.index')->with('message','Profile Updated Successfully.');
    }
    ...
    public function change_password()
    {
        ...
        return view('salesman.profile.change_password',compact('user_detail'));
    }
    ...
    public function change_password_submit(Request $request)
    {
        ...
        if(!$check_password){
            ...
            return redirect()->route('salesman.dashboard.index')->with('success','Password changed Successfully.');
        }
    }
}
