    ...
    <div class="main-content-part">
        <div class="main-content-padd">
            ...
            <div class="profile-main-sec">
                <form action="{{ route('airport_manager.city_users.store') }}" method="post" id="or_user_create"
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="from-group">
                                        <input type="hidden" id="role_id" name="role_id" value="{{ SALESMAN }}">
                                        <label>Role</label>
