            ...
            <div class="row text-right">
                <div class="col-md-12">
                    ...
                    <div class="droupdown-select">
                        <select class="form-control product_dropdown">
...
$(function() {
    ...
    function boxreportrange(start, end) {
        ...
        var url = "{{route('airport_manager.dashboard.sales_post')}}";
        $.ajax({
            url: url,
            type: 'POST',
    ...
    $(document).on('change','.product_dropdown',function()
    {
        ...
        $.ajax({
            url: url,
            type: 'POST',
            data: { _token:token, start_date:start_date, end_date:end_date, city_id:city_id, product_id: product_id },
            success : function(response)
            {
                $('.response_display').html(response);
            }
