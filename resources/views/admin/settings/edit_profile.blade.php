...
<div class="main-content-part">
    <div class="main-content-padd">
       <form action="{{route('admin.settings.profile_update')}}" enctype="multipart/form-data" method="POST" id="profile_update">
         @csrf
            ...
            <div class="row mt-5">
               ...
               <div class="col-md-10">
                  ...
                  <div class="from-group w100 button-sec">
                     ...
                     {{-- <button type="submit" value="Save" class="btn-save">Update</button><span></span>
