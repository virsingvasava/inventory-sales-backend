...
<div class="main-content-part">
   <div class="main-content-padd">
      <div class="title-w-arrow">
         <a href="{{route('admin.product.brand.index', $id)}}">
            <span><img src="{{ asset('theme/images/grey-big-arrow.png')}}"/></span>
         </a>
         <h1 class="mr20 back_title_text">{{$brand->name}}</h1>
            ...
            <div class="row mt-5">
               ...
               <div class="col-md-12">
                     ...
                     <div class="col-md-4">
                        <div class="from-group">
                           ...
                           <div class="droup-select">
                              <input type="hidden" name="brand_id" value="{{$brand->id}}" class="form-control" readonly>
                  ...
                  <div class="from-group w100 pack-size">
                     ...
                     <div class="pack-badge" id="package_size_choose">
                        ...
                        <div class="form-check or_package_size16">
                           <input class="form-check-input or_package_size3" type="checkbox" name="package_size" id="" value="16">
                              <label class="form-check-label" for="radiobutton1">
                                 16
                              </label>
                        </div>
                  ...
                  <div class="from-group w100 button-sec">
                     ...
                     {{-- <button type="submit" value="Save" class="btn-save">Save</button> --}}
