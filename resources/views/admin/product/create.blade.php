...
<div class="main-content-part">
    <div class="main-content-padd">
        <div class="title-w-arrow">
            ...
            <h1 class="mr20 back_title_text">Brand Create</h1>
        </div>
        <div class="profile-main-sec">
            <form action="{{ route('admin.brand.store') }}" method="post" id="or_kiosk_create"  enctype="multipart/form-data">
                @csrf
                <div class="row mt-5">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <div class="droup-select">
                                        <select class="nice-select form-control custom-select" name="status">
